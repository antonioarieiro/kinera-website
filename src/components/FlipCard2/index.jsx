...
const FlipCard2 = ({ title, backDesc, imgUrl, id }) => {
    return (
        <div className="flip-card-container md:w-[290px] w-full h-[555px] text-[#3c1e11]" data-aos="flip-right" >
            <div className="flip-card">
                <div className="flip-card-front flex flex-col justify-center items-center gap-5 bg-[#1D1D20] rounded-[38px] border-2 border-[#3c1e11]" id={id}>               
