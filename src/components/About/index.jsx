            ...
            <div className="w-full h-full flex flex-col">
                ...
                <div className="w-full flex justify-center mt-10">
                    <div className="w-[80%]">
                        ...
                        <p className="text-[19px] text-center mt-10" data-aos="fade-right">With a set of tools built upon a system of tokenized incentives, users can create film and video competitions and rankings where the values and interests of the community can emerge.</p>
                        ...
                        <p className="text-[19px] text-center mt-10" data-aos="fade-right">Content moderation is made by the community and reinforced by a platform design that drives the users to forms of participation according to the community rules. In this way, members can choose their level of engagement in an environment aligned with their values.  </p>
