            ...
            <div className="w-full h-full flex flex-col">
                ...
                <div className="w-full flex justify-center mt-10">
                      <div className="card-container w-[80%]">
                        ...
                        <p className="text-[19px] text-center -mt-0" data-aos="fade-left"><span class="glitch">Kinera</span> is the home for the best audiovisual media content in the Web3 environment. </p>
                        </div>
                        <div className="card" data-aos="fade-left">
                        ...
                        <div className="card" data-aos="fade-left">
                        <p className="text-[19px] text-center mt-0" data-aos="fade-right"><span class="glitch">Kinera's </span> media platform is the place to nurture, empower, and give voice to people from different cultural and political backgrounds.</p>
                        </div>
                        <div className="card" data-aos="fade-left">
