        ...
        >
            ...
            >
                ...
                <div className="w-full flex flex-col gap-10 mt-20" data-aos="zoom-in">
                    ...
                    <p className="text-center text-[19px] font-extralight">If you want to participate and get information about the funding process subscribe our newsletter HERE.</p>
                </div>
            </div>
        </div>
    )
