                ...
                <div className="main-content">
                    ...
                    <div className='global-mobile'>
                        <div className="content-wrapper mt-0">
                            ...
                            <p className="mt-6 text-base text-center" style={{ zIndex: 1, fontSize: '16px', color: "#351e2d"  }}>
                            ...
                            <p className="text-base text-center mt-6" style={{ zIndex: 1, fontSize: '16px', color: "#351e2d" }}>
