        ...
        >
            ...
            <div className="w-full min-h-[90vh] flex flex-col items-center justify-center lg:px-10 px-2 gap-y-6 mt-10">
                <div className="w-full flex lg:flex-row flex-col items-center">
                    <div className="flex flex-col lg:w-1/2 w-full gap-20">
                    ...
                    <div className="lg:w-[35rem] w-full h-[35rem] mt-10 relative sm:block hidden">
                        <img src={BigK02} alt='BigK02' className="w-[34.375rem] absolute bottom-[12%] left-0 pulse" />
                        <img src={BigK} alt='BigK' className="w-[12rem] absolute bottom-[25%] left-1/3 right-0 z-10 pulse" />
                        <img src={BigK03} alt='BigK03' className="w-[37.5rem] absolute bottom-[10%] left-0" />
                    </div>
