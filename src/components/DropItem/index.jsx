...
const DropItem = ({ answer, question }) => {
    ...
    return (
        <div className='sm:w-2/3 w-full flex flex-col'>
            ...
            <div className={`w-full bg-[#333] text-white mt-5 px-5 py-4 shadow-xl origin-bottom duration-500 ease-in-out ${showAnswer ? 'opacity-100 min-h-56' : 'opacity-0 pointer-events-none h-0'}`}>
                {answer}
            </div>
        </div>
    );
