...
const FlipCard = ({ title, backDesc, imgUrl, icon }) => {
    return (
        <div className="flip-card-container md:w-[265px] w-full h-[555px] text-white" data-aos="flip-right" >
            <div className="flip-card">
                <div className="flip-card-front flex flex-col justify-center items-center gap-5 bg-[#1D1D20] rounded-[38px] border-2 border-[#FF0A78]">
