    ...
    return (
        ...
        >
            ...
            <div className="w-full flex flex-col gap-10 mt-10" data-aos="zoom-in">
                ...
                <p className="text-center hover:text-[#FF0A78] text-[19px] font-extralight">
                Our proposal is to utilise the Kinex token for content curation on the Kinera platform. We anticipate the emergence of curation tokens and curation markets in the next few years, as they are the most effective tools for categorising information and are likely to capture people's imagination, similar to the way NFTs did.
                </p>
                <p className="text-center hover:text-[#FF0A78] text-[19px] font-extralight">
