    ...
    return (
        <header className="flex flex-col lg:flex-row items-center justify-center w-full px-10 py-2 border-b border-white bg-[#FFFFFF] text-[#3c1e11]">
            ...
            <nav className={`flex flex-col lg:flex-row items-center gap-4 lg:gap-8 mt-6 lg:mt-0 ${showDropDownMenu ? 'block' : 'lg:block hidden'} lg:flex`}>
                <a href="/#home" className="text-base hover:text-[#6a466a]">Home</a>
                <div className="group relative z-10">
                    <button className="flex items-center gap-2 text-#3c1e11 group-hover:text-[#6a466a] text-base">
                        Kinera
                        <IoIosArrowDown className="text-[#6a466a] group-hover:text-[#3c1e11]" />
                    </button>
                    <div className="invisible group-hover:visible group-hover:opacity-100 rounded w-60 absolute left-0 top-full transition-all opacity-0 bg-[#3c1e11] shadow-xl py-1">
                        <ul>
                            <li><a className="text-[#FFFFFF] block px-4 py-2 hover:bg-[#6a466a]" href="/#about">About</a></li>
                            {/*<li><a className="text-[#FFFFFF] block px-4 py-2 hover:bg-[#6a466a]" href="/#mission">Mission</a></li>*/}
                            <li><a className="text-[#FFFFFF] block px-4 py-2 hover:bg-[#6a466a]" href="/#kinex">Kinex Token</a></li>
                            <li><a className="text-[#FFFFFF] block px-4 py-2 hover:bg-[#6a466a]" href="/#struct">Kinera Structure</a></li>
                            <li><a className="text-[#FFFFFF] block px-4 py-2 hover:bg-[#6a466a]" href="/#participation">Types of Participation</a></li>
                            <li><a className="text-[#FFFFFF] block px-4 py-2 hover:bg-[#6a466a]" href="https://drive.google.com/file/d/1zoowL-_N_BlzWLCeMEqmjDXY3JZ6HDQL/view?usp=share_link" target="_blank">Lightpaper</a></li>
                        </ul>
                    </div>
                </div>
                ...
                {/* New Button Added */}
                <a href="https://alpha.kinera.network/" target="_blank" rel="noopener noreferrer" className="ml-4 px-4 py-2 bg-[#3c1e11] hover:bg-[#6a466a]/80 transition duration-300 ease-in-out rounded text-white">Launch dAPP</a>
            </nav>
        </header>
    );
}
