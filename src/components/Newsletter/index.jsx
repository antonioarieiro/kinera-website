    ...
    return (
        ...
        >
            <div className="w-full p-10 flex flex-col items-center justify-center gap-20" data-aos="zoom out">
                <h1 className="sm:text-[75px] text-[38px] font-bold text-center text-[#2f1834] -mt-4">
                ...
                <div className="w-full flex justify-center flex-wrap gap-10">
                    <a
                        ...
                        className="bg-[#2f1834] hover:bg-[#6a466a] duration-500 text-[#ffffff] hover:text-white text-lg font-bold px-3 py-2 rounded-3xl min-w-1/2 text-center"
                        style={{ width: '250px' }}
                    >
                        Sign Up
                    </a>
