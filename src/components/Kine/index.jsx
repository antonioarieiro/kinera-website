...
const Kine = () => {
    return (
        ...
        >
            ...
            <h1 className="-mt-12 sm:text-[75px] text-[38px] font-bold text-center text-[#000000] py-10" data-aos="zoom-in">THE KINEX</h1>
            
            <div className="-mt-2 container mx-auto flex flex-col md:flex-row mt-0 md:px-0 px-4 justify-center" style={{ gap: '5rem' }}>
                <div className="w-full md:w-1/2 flex justify-center">
                <img src={token} alt="claquete" className="w-[75%] object-contain animate-pulse" />
                </div>
