        ...
        >
            <div className="container mx-auto px-4">
                ...
                <div className="w-[80%]" data-aos="zoom-in">
                    <p className="text-[25px] text-center text-[#6a466a]">Join the Kinera platform and become an active member of the ecosystem as a <strong>Curator</strong>, <strong>Moderator</strong>, <strong>Ambassador</strong> and or <strong> Creator</strong>:</p>
                </div>
                </div>
                ...
                <div className="my-20 flex flex-col gap-10">
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-4" data-aos="fade-right">
                        <DropItem
                          question="Creators"
                          answer={<p style={{ fontSize: '20px', color: '#000000' }}><strong>CREATORS</strong> are the members who craft distinctive and captivating content from our curated lists to create streaming channels. These channels may be further enhanced with interviews and live events, providing a comprehensive viewing experience.</p>}
                        />
