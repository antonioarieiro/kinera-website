            ...
            <div className="container mx-auto px-4">
                ...
                <div className="w-full flex justify-center mt-10">
                    <div className="w-[80%]" data-aos="">
                        <p className="text-[18px] text-center text-[#3c1e11]">Inside Kinera, you can be a <strong> Creator</strong>, a <strong>Curator</strong>, a <strong>Moderator</strong> or a <strong>User</strong>.</p>
                    </div>
                </div>
                ...
                <div className="participation-container my-20 flex flex-col gap-20">
                    ...
                    <div className="text-justify dropitem-container flex flex-col md:flex-row-reverse items-center gap-4" data-aos="">
                        <DropItem
                          question="Creators"
                          answer={<p style={{ fontSize: '16px', color: '#3c1e11' }}><strong>CREATORS</strong> are members who craft distinctive and captivating content from our curated lists or create their videos with the <u>Producer's tools</u> to launch streaming channels.   These channels can also host recorded interviews and live events, providing a full viewing experience with a diverse range of content that caters to different viewers interests and preferences.</p>}
                        />
                    ...
                    <div className="text-justify dropitem-container flex flex-col md:flex-row-reverse items-center gap-4" data-aos="">
                        <DropItem
                          question="Users"
                          answer={<p style={{ fontSize: '16px', color: '#3c1e11' }}><strong>USERS</strong> shape the culture and direction of the network. At any time they can change roles and become creative, taking part, creating new communities, or being active members of the governance. Users have the power to influence and drive change, to shape the platform into something that reflects their values and interests. The more active and engaged the users are, the more vibrant and successful Kinera becomes.</p>}
                        />
