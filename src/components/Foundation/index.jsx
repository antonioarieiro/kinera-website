        ...
        >
            ...
            <div className="container mx-auto flex flex-col md:flex-row -mt-10 md:px-20 px-4 justify-center" data-aos="fade-left" style={{ gap: '5rem' }}>
                ...
                <div className="md:w-1/2 w-full" data-aos="fade-left">
                    ...
                    <p className="text-[19px] md:text-left text-center my-10"><span class="glitch"> Kinera, the platform developed by the Kine Foundation,</span> operates as a community-governed ecosystem where the community's vision and decisions will evolve from representative democracy to futarchy and other processes that combine reputation, token value and curation markets. This ensures that the platform remains aligned with its mission and its users have a voice in its ongoing development and evolution.</p>
                </div>
            </div>
        </div>
    )
