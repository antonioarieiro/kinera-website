import kineraFund03 from '../../assets/images/kineraFund04.webp'
import fundation01 from '../../assets/images/fundation02.webp'
        ...
        >
            ...
            <div className="card-kinefund-container w-[100vk]">
                    ...
                    <div className="card-kinefund" data-aos="fade-left">
                        <p className="text-[19px] text-center my-0"><span className="glitch"> The Kine Foundation</span> is the legal structure committed to building and supporting <b>Kinera-related technologies</b> and the <b>Kinex token</b>. </p>
                    </div>
                    <div className="card-kinefund" data-aos="fade-left">
