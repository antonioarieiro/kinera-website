        ...
        >
            ...
            <div className="container mx-auto flex flex-col md:flex-row -mt-10 md:px-20 px-4 justify-center" style={{ gap: '5rem' }}>
                ...
                <div className="md:w-1/2 w-full" data-aos="fade-left">
                    <p className="text-[19px] md:text-left text-center my-10"><span class="glitch"> The Kine Foundation</span> is a non-profit organization in the process of being  created. </p>
                    ...
                    <p className="text-[19px] md:text-left text-center my-10">The foundation's mission is to transform and transcend traditional approaches to audiovisual production, curation and exhibition, fostering an ecosystem  where content creators themselves get  more than 99% of the revenue from their content.</p>
                    <p className="text-[19px] md:text-left text-center my-10">With Kinera, the Kine Foundation is committed to encouraging active audience engagement by embracing a new paradigm.</p>
